# This is a very interesting mini game, where you will be provided with attempts based on the difficulty level chosen.
# In these many attempts you have to guess the number chosen by the system.
